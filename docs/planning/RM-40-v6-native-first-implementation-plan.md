...
| 5 · Add the missing task, schedule and action contracts | ✅ Native cron owns both reports, 7 Sep 2026; duplicate guard and restart no-replay live-verified. **Unattended first fire and Notion read-back still pending.** The held-notice sweep stays Real-Ming-owned by design, not by omission | [Extension evidence](../evidence/RM-40-v6-milestone-5-extension-evidence.md) and [scheduler ownership evidence](../evidence/RM-40-v6-milestone-5-scheduler-ownership-evidence.md). Ownership is native-hermes-cron with two active jobs at +08:00; the duplicate guard skipped an already-delivered brief and a real roll-up composed and delivered; restart replayed nothing. See [cron cutover evidence](../evidence/RM-40-v6-milestone-5-cron-cutover-2026-09-07.md) |
...
| 8 · Complete acceptance scenarios | 🔄 Notion read-back exact and honest-failure verified live 7 Sep 2026; **the DuitSini tracer is blocked on a checkout and credential** | [Milestone 8 evidence](../evidence/RM-40-v6-milestone-8-acceptance-evidence.md) and [live acceptance](../evidence/RM-40-v6-milestone-8-9-live-2026-09-07.md) |
...
The immediate next work is **milestone 5's deliberate native-cron staging and
one real Notion versioned read-back**. Then complete the Malaysia live memory,
private-dashboard and end-to-end acceptance checks in milestones 6–9. Native
Telegram remains the primary user experience; the private dashboard is a
