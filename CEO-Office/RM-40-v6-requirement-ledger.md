...
| V6-TASK-1 | Master Tasks is the canonical Notion source; six linked Work Views | **Keep** | Retained `notion-provider-adapter.ts` behind a native tool | Live-verified at R5 (cutover completed) | Milestone 5 read-back |
| V6-TASK-2 | Legacy status semantics: Pending=Captured, To Do=Planned, Issues=Waiting/Blocked, Pending to Review=Ready for CEO Review, Done=Completed | **Keep** | `docs/agents/notion-task-status-semantics.md` | Live-verified at R5 | Milestone 5 field-by-field authority decision |
| V6-TASK-3 | Native durable execution tasks | **New** | Native Kanban, linked to Work Items by stable ID | Present, unused | Milestone 5 |
| V6-DAILY-1 | 07:30 brief, 21:30 roll-up, DND 23:00–07:00, lighter weekends, Asia/Kuala_Lumpur | **Keep** | Native cron, one owner per job | Controlled-tested at R5; **no native cron jobs exist** | Milestone 5 |
